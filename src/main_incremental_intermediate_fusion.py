...
from datasets.data_loader_multistream_his import get_loaders
...
def main(argv=None):
    ...
    # Args -- Network
    from networks.network_intermediate_fusion import LLL_Net
    ...
    from approach.incremental_learning_multistream_histo import Inc_Learning_Appr

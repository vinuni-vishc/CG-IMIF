...
from datasets.data_loader_multistream_contour import get_loaders
...
def main(argv=None):
    ...
    parser.add_argument('--results-path', type=str, default='../new_results',
    ...
    args.results_path = os.path.expanduser(args.results_path+'/seed'+str(args.seed))
    ...
    # Args -- Network
    from networks.network_multistream_contour_intermediate import LLL_Net
    ...
    from approach.incremental_learning_multistream_contour import Inc_Learning_Appr

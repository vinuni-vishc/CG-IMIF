...
def main(argv=None):
    ...
    # Args -- Network
    from networks.network_multistream import LLL_Net
    ...
    from approach.incremental_learning_multistream import Inc_Learning_Appr
    ...
    from datasets.exemplars_dataset_multistream import ExemplarsDataset
